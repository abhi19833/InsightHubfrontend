        ...
        setInsights([
          {
            ...
            message: `Failed to load AI insight: ${error.message}. Pleasee check your network and server.`,
            icon: AlertTriangle,
            color: "text-red-500",
            priority: "high",
          },
      ...
      setInsights([
        {
          ...
          message:
            "Add tasks and projects to receive powerful insights from Gemini AI.",
          icon: Brain,
