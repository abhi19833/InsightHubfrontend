...
import api from "../api/axiosInstance"; // Import the authenticated axios instance

const API_URL = "/projects"; // Base URL is already set in axiosInstance
...
const Projects = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    if (editingProject) {
      ...
      try {
        const { data: newProject } = await api.post(API_URL, projectForm);
